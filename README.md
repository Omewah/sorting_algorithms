...
This is an algorithm-based project in C Programming Language, by **Omewah Joel and Precious Okolie**. Several sorting algorithms are implemented, as well as their corresponding Big O notations.
